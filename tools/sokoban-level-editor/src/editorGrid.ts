...
const shiftRoleAppearance = (roleAppearance: Record<string, unknown>, offset: Offset) => {
...
const cropRoleAppearance = (roleAppearance: Record<string, unknown>, bounds: Bounds) => {
