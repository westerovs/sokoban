...
;// ./adapters/Dev/DevAdapter.ts
function DevAdapter_defineProperty(e, r, t) { return (r = DevAdapter_toPropertyKey(r)) in e ? Object.defineProperty(e, r, { value: t, enumerable: !0, configurable: !0, writable: !0 }) : e[r] = t, e; }
function DevAdapter_toPropertyKey(t) { var i = DevAdapter_toPrimitive(t, "string"); return "symbol" == typeof i ? i : i + ""; }
function DevAdapter_toPrimitive(t, r) { if ("object" != typeof t || !t) return t; var e = t[Symbol.toPrimitive]; if (void 0 !== e) { var i = e.call(t, r || "default"); if ("object" != typeof i) return i; throw new TypeError("@@toPrimitive must return a primitive value."); } return ("string" === r ? String : Number)(t); }





class DevAdapter extends Adapter {
  constructor() {
    super(...arguments);
    DevAdapter_defineProperty(this, "platform_prefix", "dev");
  }
  gameReady() {
...
;
var __webpack_exports__DevAdapter = __webpack_exports__.N;
export { __webpack_exports__DevAdapter as DevAdapter };
