...
function BaseAdapter_defineProperty(e, r, t) { return (r = BaseAdapter_toPropertyKey(r)) in e ? Object.defineProperty(e, r, { value: t, enumerable: !0, configurable: !0, writable: !0 }) : e[r] = t, e; }
function BaseAdapter_toPropertyKey(t) { var i = BaseAdapter_toPrimitive(t, "string"); return "symbol" == typeof i ? i : i + ""; }
function BaseAdapter_toPrimitive(t, r) { if ("object" != typeof t || !t) return t; var e = t[Symbol.toPrimitive]; if (void 0 !== e) { var i = e.call(t, r || "default"); if ("object" != typeof i) return i; throw new TypeError("@@toPrimitive must return a primitive value."); } return ("string" === r ? String : Number)(t); }

class BaseAdapter extends Adapter {
  constructor() {
    super(...arguments);
    BaseAdapter_defineProperty(this, "platform_prefix", "base");
  }
  getLang() {
    return "ru";
  }
