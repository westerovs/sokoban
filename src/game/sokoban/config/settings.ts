/**
 * Хранит настраиваемые параметры игрового поля и интерфейса Sokoban.
 */

const SOKOBAN_SETTINGS = Object.freeze({
  tileSize: 100, // Базовый размер клетки до адаптивного масштабирования
  textureTileSize: 100, // Размер исходной квадратной текстуры, соответствующий одной логической клетке
  ...
  continuousMoveEase: 'none', // Равномерная скорость ходьбы без торможения на границах клеток
  ...
  maxBoardRows: 20, // Максимальное количество строк игровой доски
