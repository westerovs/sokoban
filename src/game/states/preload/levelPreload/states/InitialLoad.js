...
export default class InitialLoad {
  ...
  static promoSpriteSheetPromise = () => {
    if (!InitialLoad._promoSpriteSheetPromise) {
      InitialLoad._promoSpriteSheetPromise = LoadUtils
        .loadSpriteSheet({spriteSheetName: 'promo'})
        .catch((error) => {
  ...
  static skinsSpriteSheetPromise = () => {
    if (!InitialLoad._skinsSpriteSheetPromise) {
      InitialLoad._skinsSpriteSheetPromise = LoadUtils
        .loadSpriteSheet({spriteSheetName: 'skins'})
        .catch((error) => {
