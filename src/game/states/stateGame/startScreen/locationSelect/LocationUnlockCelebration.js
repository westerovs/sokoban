...
export default class LocationUnlockCelebration extends Container {
  ...
  start = ({card, cardScale, height, isNarrow, locationName, scale, width}) => {
    this.stop()
    if (!card) return
  ...
  resize = ({cardScale, height, isNarrow, scale, width}) => {
